...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Ca_LVAst /home/vrhaynes/workspace/Haynes2021_EAPs/test_bbp_models/NMLCL000687-NEURON/x86_64/Ca_LVAst.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/vrhaynes/workspace/Haynes2021_EAPs/test_bbp_models/NMLCL000687-NEURON/Ca_LVAst.mod";
static const char* nmodl_file_text = 
  ...
  "    \n"
  "    ? DerivedVariable is based on path: timeCourse/t, on: Component(id=m type=gateHHtauInf), from timeCourse; Component(id=null type=Ca_LVAst_m_tau_tau)\n"
  ...
  "    \n"
  "    ? DerivedVariable is based on path: timeCourse/t, on: Component(id=h type=gateHHtauInf), from timeCourse; Component(id=null type=Ca_LVAst_h_tau_tau)\n"
