...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "area");
 	...
 	ivoc_help("help ?1 CaDynamics_E2_NML2__cADpyr_232_axonal /mnt/c/Users/Research/workspace/phd_audition/NeuronProfiler/models/NMLCL000687-NEURON/x86_64/CaDynamics_E2_NML2__cADpyr_232_axonal.mod\n");
